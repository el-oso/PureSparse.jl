...
# This file holds several engines at different maturity. For a maintainer, which is which:
#
...
#
#   REFERENCE, SUPERSEDED (§4 left-looking — kept ONLY as the measured baseline the multifrontal
#   path beat; NOT on any shipped path, see the §M perf notes / crossover constants):
#     gpu_cholesky_sync!  (all-GPU left-looking)   +  _scatter_add! (kernel)
#     gpu_cholesky_hybrid! (hybrid  left-looking)
#
#   VENDOR (cuBLAS §8-gate reference arm 4): split out to gpu_vendor_solve.jl.
# ================================================================================================

# --- REFERENCE (superseded left-looking, §4) — retained measured baseline, never shipped ---
